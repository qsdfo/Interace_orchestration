...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1468.5, 218.932373000000013, 29.5, 22.0 ],
					"text" : "* 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 700.5, 555.949035999999978, 39.0, 20.0 ],
					"text" : "select"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 753.5, 583.565429999999992, 34.0, 20.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.5, 583.565429999999992, 36.0, 20.0 ],
					"text" : "close"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 48.359282999999998, 490.170898000000022, 281.0, 44.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 97.0, 18.284362999999999, 217.0, 50.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 97.0, 18.284362999999999, 217.0, 50.0 ],
									"text" : "ACIDS Plugins",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 97.0, 74.113792000000004, 217.0, 5.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"pic" : "ACIDS_logo.png",
									"presentation" : 1,
									"presentation_rect" : [ 15.0, 14.284363000000001, 72.0, 56.829430000000002 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 489.0, 219.890320000000003, 87.0, 22.0 ],
									"text" : "closebang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 489.0, 170.284363000000013, 73.0, 22.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
,
					...
					"saved_object_attributes" : 					{
						...
						"digest" : "",
						"globalpatchername" : "",
						"locked_bgcolor" : [ 0.309804, 0.329412, 0.329412, 1.0 ],
						"tags" : ""
					}
,
					"text" : "p Window",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.5, 610.45581100000004, 50.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 761.0, 494.0, 76.0, 58.455810999999997 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1514.5, 211.216186999999991, 1478.0, 211.216186999999991 ],
					"order" : 0,
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1478.0, 245.932373000000013, 1462.5, 245.932373000000013, 1462.5, 211.932373000000013, 1443.0, 211.932373000000013 ],
					"source" : [ "obj-55", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "acids.button.graphics.maxpat",
				"bootpath" : "~/Recherche/Arte_orchestration/Orchestration/Max_server/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "internal.png",
				"bootpath" : "~/Recherche/Arte_orchestration/Orchestration/Max_server/patchers/graphics/icons_white_50",
